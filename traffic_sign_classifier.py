...
Original file is located at
    https://colab.research.google.com/drive/15v_1KsgFFa5nauB_izCjt4iYrfFICKya
...
"""<h1>Personal Note</h1>
Data appears uniform although each part of the dataset doesn't have equal sizes.  This should be ok though, but something to keep in mind if I run into problems detecting specific signs that should be classified out of the 43.
"""
...
"""<h1>Personal Note</h1>
I tried to use YUV, but kind of ran out of time.  In the paper recommended by the class, from Pierre Sermanet and Yann LeCun, they said they used it.  I am still curious exactly how they did it.
